...
| `where [command \| alias \| builtin]+`                          | Display all the founded utilitys for each parameters in order: Builtin \| Alias \| Path found in `PATH` environement variable \| Not Found                              |
